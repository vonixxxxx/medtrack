          ...
          {features.map((feature, index) => {
            ...
            return (
              <motion.div
                ...
                whileHover={{ y: -8 }}
                className="group relative p-8 bg-gradient-to-br from-gray-50 to-white rounded-3xl border border-gray-100 hover:border-primary-200 transition-all shadow-sm hover:shadow-xl"
              >
                ...
                <div className="absolute inset-0 rounded-3xl bg-gradient-to-br from-primary-500/0 to-blue-500/0 group-hover:from-primary-500/5 group-hover:to-blue-500/5 transition-all -z-10" />
              </motion.div>
            );
          })}
        </div>
          ...
          {additionalFeatures.map((feature, index) => {
            ...
            return (
              <motion.div
                ...
                className="p-6 bg-gray-50 rounded-2xl border border-gray-100 hover:border-primary-200 transition-all"
              >
                <Icon className="text-primary-600 mb-4" size={24} />
