      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32">
        <div className="text-center">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-2 bg-primary-50 border border-primary-200 rounded-full text-primary-700 text-sm font-medium mb-8"
          >
            <Sparkles size={16} />
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              onClick={scrollToCTA}
              className="group px-8 py-4 bg-primary-600 text-white rounded-full font-semibold text-lg shadow-xl shadow-primary-600/25 hover:shadow-2xl hover:shadow-primary-600/40 transition-all flex items-center gap-2"
            >
              Get Started
            ...
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="px-8 py-4 bg-white text-gray-900 rounded-full font-semibold text-lg border-2 border-gray-200 hover:border-primary-300 transition-all"
            >
              Learn More
            </motion.button>
          </motion.div>
          ...
          >
            <div className="relative max-w-5xl mx-auto">
              <div className="aspect-video bg-gradient-to-br from-primary-100 to-blue-100 rounded-3xl shadow-2xl border border-primary-200/50 flex items-center justify-center overflow-hidden">
                {/* Dashboard Mockup */}
                <div className="absolute inset-4 bg-white rounded-2xl shadow-xl p-8">
                  <div className="grid grid-cols-3 gap-4 h-full">
                    {[1, 2, 3].map((i) => (
                      <div key={i} className="bg-gradient-to-br from-primary-50 to-blue-50 rounded-xl p-4">
                        <div className="h-2 bg-primary-200 rounded-full mb-2 w-3/4" />
                        <div className="h-2 bg-primary-200 rounded-full mb-2 w-1/2" />
                        <div className="h-20 bg-primary-100 rounded-lg mt-4" />
                      </div>
                    ))}
                  </div>
                </div>
