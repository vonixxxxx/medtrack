...
export default function Collaboration() {
  return (
    <section className="py-24 lg:py-32 bg-gradient-to-br from-gray-50 to-primary-50/30">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          {partners.map((partner, index) => (
            <motion.div
              ...
              whileHover={{ y: -8 }}
              className="group p-8 bg-white rounded-3xl border border-gray-200 hover:border-primary-300 transition-all shadow-sm hover:shadow-xl"
            >
