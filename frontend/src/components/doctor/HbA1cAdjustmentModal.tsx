      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="bg-neutral-900 rounded-3xl border border-neutral-800 p-6 w-full max-w-4xl max-h-[90vh] overflow-y-auto"
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 bg-neutral-800 border border-neutral-700 rounded-xl text-white focus:ring-2 focus:ring-white focus:border-white"
                      placeholder="7.5"
                    />
                  </div>
                    ...
                    {medications.map((med, index) => (
                      <div key={med.name} className="flex items-center gap-3">
                        ...
                        <input
                          ...
                          className="w-20 px-2 py-1 bg-neutral-800 border border-neutral-700 rounded text-white text-sm focus:ring-1 focus:ring-white focus:border-white"
                          placeholder="0"
                        />
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    className="flex-1 bg-primary-600 text-white py-2 px-4 rounded-xl hover:bg-primary-700 focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 focus:ring-offset-neutral-900 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                  ...
                  <button
                    onClick={handleReset}
                    className="px-4 py-2 bg-neutral-700 text-white rounded-xl hover:bg-neutral-600 transition-colors"
                  >
                    Reset
                  </button>
                </div>
                ...
                {error && (
                  <div className="p-3 bg-error-900/20 border border-error-800 rounded-xl text-error-400 text-sm">
                    {error}
                  </div>
                )}
              </div>
                ...
                {result ? (
                  <div className="space-y-4">
                    <div className="bg-neutral-800 rounded-xl p-4">
                      <div className="grid grid-cols-2 gap-4">
                        <div className="text-center">
                          ...
                          <div className="text-sm text-neutral-400">MES Score</div>
                        </div>
                        <div className="text-center">
                          <div className="text-2xl font-bold text-green-400">
                            {result.adjustedHbA1cPercent.toFixed(1)}%
                          </div>
                          <div className="text-sm text-neutral-400">Adjusted HbA1c (%)</div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-neutral-800 rounded-xl p-4">
                      ...
                      <div className="space-y-2 text-sm">
                        <div className="flex justify-between">
                          <span className="text-neutral-400">Measured HbA1c:</span>
                          <span className="text-white">{measuredHbA1c}%</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-neutral-400">MES Adjustment:</span>
                          <span className="text-white">+{result.MES.toFixed(2)}</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-neutral-400">Adjusted HbA1c (%):</span>
                          <span className="text-white font-medium">{result.adjustedHbA1cPercent.toFixed(2)}%</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-neutral-400">Adjusted HbA1c (mmol/mol):</span>
                    ...
                    <div className="bg-primary-900/20 border border-primary-800 rounded-xl p-4">
                      <h4 className="text-sm font-medium text-primary-300 mb-2">Clinical Interpretation</h4>
                  ...
                  <div className="bg-neutral-800 rounded-xl p-8 text-center">
                    ...
                    <p className="text-neutral-400">Enter values and click "Calculate Adjustment" to see results</p>
                  </div>
                )}
              </div>
            </div>
