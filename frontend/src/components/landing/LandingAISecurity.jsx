    ...
    <section id="security" className="py-24 lg:py-32 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              {securityFeatures.map((feature, index) => {
                ...
                return (
                  <motion.div
                    ...
                    transition={{ duration: 0.6, delay: index * 0.1 }}
                    whileHover={{ y: -4 }}
                    className="p-6 bg-gradient-to-br from-gray-50 to-white rounded-2xl border border-gray-100 hover:border-blue-200 transition-all"
                  >
        ...
        <motion.div
          ...
          className="mt-20"
        >
          <div className="bg-gradient-to-br from-blue-50 to-blue-50 rounded-3xl p-12 border border-blue-100">
            <div className="flex flex-col md:flex-row items-center justify-between gap-8">
              {[
                ...
                { label: "Secure Storage", color: "bg-blue-500" },
              ].map((step, index) => (
